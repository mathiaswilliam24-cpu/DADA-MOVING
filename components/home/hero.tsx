        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight mb-4">
              Rent a Van for
              <span className="block text-[#f59e0b]">Only $17/Hour</span>
            </h1>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-2xl">
              ...
              <p className="text-xs text-[#94a3b8] mt-2 text-center">Starting from $17/hr · Minimum 2 hours</p>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="absolute -top-4 -right-4 bg-[#f59e0b] rounded-2xl shadow-xl p-4 text-center">
              ...
              <div className="text-xs text-amber-100 font-semibold">per hour</div>
            </div>
          </div>
        </div>
      </div>
